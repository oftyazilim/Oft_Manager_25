...
$(function () {
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            return (
              ...
              `<button class="btn btn-sm btn-icon edit-record btn-text-secondary rounded-pill waves-effect" data-id="${full['id']}" data-bs-toggle="modal" data-bs-target="#myModal1"><i class="ti ti-edit"></i></button>` +
  ...
  $(document).on('click', '.edit-record', function () {
    ...
    $('#modalBaslik').html('Kullanıcı Bilgileri (Düzenleme)');
  ...
  $('.add-new').on('click', function () {
    ...
    $('#addUserBaslikLabel').html('Yeni Kullanıcı');
  });
    ...
    fields: {
      name: {
        validators: {
          ...
          regexp: {
            regexp: /^[a-zA-Zs]+$/,
            message: 'Adınız Alfabetik Karakterler olmalı'
          }
        }
      },
      email: {
...
//   axios.get('/table/test').then(function (response) {
//     data = response.data;
//     console.log(data[0].HAT);
...
//             var $status = {
//               1: { title: 'Başlamadı', class: 'bg-label-primary' },
//               2: { title: 'Üretilecek', class: ' bg-label-success' },
//               3: { title: 'Üretimde', class: ' bg-label-danger' },
//               4: { title: 'Tamamlandı', class: ' bg-label-warning' },
//               5: { title: 'İptal', class: ' bg-label-info' }
//             };
...
//           text: '<i class="ti ti-file-export ti-xs me-sm-1"></i> <span class="d-none d-sm-inline-block">Dışarı Aktar</span>',
//           buttons: [
//             {
//               extend: 'print',
...
//         },
//         {
//           text: '<i class="ti ti-plus add-record me-sm-1"></i> <span class="d-none d-sm-inline-block">Yeni Kayıt</span>',
//           className: 'add-new btn btn-primary waves-effect waves-light',
//           attr: {
//             'data-bs-toggle': 'offcanvas',
//             'data-bs-target': '#offcanvasAddUser'
...
//     });
//     $('div.head-label').html('<h5 class="card-title mb-0">İş Emirleri</h5>');
