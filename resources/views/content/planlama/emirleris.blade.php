            ...
            <div class="offcanvas-body mx-0 flex-grow-0 p-6 h-100">
                <form class="add-new-record pt-0" id="addNewRecordForm">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" id="MMLGRPKOD" class="form-control dt-input" name="MMLGRPKOD"
                            disabled></input>
                    </div>
                    ...
                    <div class="row  mb-3">
                        <div class="col-7">
                            ...
                            <input type="number" id="URETIMSIRA" class="form-control dt-input"
                                name="URETIMSIRA"></input>
                        </div>
