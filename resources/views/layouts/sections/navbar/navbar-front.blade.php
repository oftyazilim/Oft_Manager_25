  ...
  <div class="container">
    <div class="navbar navbar-expand-lg landing-navbar px-3 px-md-8">
      ...
      <ul class="navbar-nav flex-row align-items-center ms-auto">
        ...
        <!-- navbar button: Start -->
        <li>
          <a href="{{ route('login') }}" class="btn btn-primary"><span class="tf-icons ti ti-login scaleX-n1-rtl me-md-1"></span><span class="d-none d-md-block">Kullanıcı Girişi</span></a>
        </li>
        <!-- navbar button: End -->
      </ul>
      <!-- Toolbar: End -->
